...
/*<!--jsonlyinproPHP-->*/
require_once JOOMSPORT_PATH_INCLUDES . 'moderator' . DIRECTORY_SEPARATOR . 'joomsport-moderate-actions.php';

add_filter( 'site_transient_update_plugins', 'JSmy_filter_plugin_updates' );
function JSmy_filter_plugin_updates($value){
    if(isset($value->response['joomsport-sports-league-results-management/joomsport.php'])){
        $value->response['joomsport-sports-league-results-management/joomsport.php']->url = 'http://joomsport.com';
        $value->response['joomsport-sports-league-results-management/joomsport.php']->package = '';
