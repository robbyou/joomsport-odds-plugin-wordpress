...
class JoomSportBoxField_Plugin {
	...
	public function screen_option() {
            if(isset($_POST['wp_screen_options']['option'])){
                update_user_meta(get_current_user_id(), 'boxfields_per_page', sanitize_text_field($_POST['wp_screen_options']['value']));
    ...
    <div class="jsBepanel">
		...
		<table>
			...
			<tr>
				...
				<td>
                                    <?php /*<!--jsonlyinproPHP-->*/?>
                                    <?php echo wp_kses($lists['composite'], JoomsportSettings::getKsesRadio());?>
                                    <?php /*<!--/jsonlyinproPHP-->*/?>
                                    <?php /*<!--jsaddlinkPHPText-->*/ ?>
				</td>
			</tr>
			<tr  class="jshideforcomposite">
				...
				<td>
                                    <?php /*<!--jsonlyinproPHP-->*/?>
				    <?php echo wp_kses($lists['parent'], JoomsportSettings::getKsesSelect());?>
                                    <?php /*<!--/jsonlyinproPHP-->*/?>
                                    <?php /*<!--jsaddlinkPHPText-->*/ ?>
				</td>
			</tr>
			...
			<tr class="jshideforcomposite">
				...
				<td>
                                    <?php /*<!--jsonlyinproPHP-->*/?>
				    <?php echo wp_kses($lists['extraf'], JoomsportSettings::getKsesSelect());?>
                                    <?php /*<!--/jsonlyinproPHP-->*/?>
                                    <?php /*<!--jsaddlinkPHP-->*/ ?>
