...
class JoomSportPostSeason {
    ...
    public static function admin_init(){
        ...
        /*<!--jsonlyinproPHP-->*/
        add_meta_box('joomsport_season_registartion_form_meta_box', __('Registration', 'joomsport-sports-league-results-management'), array('JoomSportMetaSeason','js_meta_sregistration'), 'joomsport_season', 'joomsportintab_season3', 'default');
        /*<!--/jsonlyinproPHP-->*/
    ...
    public static function joomsport_teamstat_shortcode(){
        ...
        <div class="JSshrtPop">
            ...
            <div>
                <label class="jsradiodivlabel"><?php echo __("Oredering", "joomsport-sports-league-results-management");?></label>
                <div class="jsradiodiv">
