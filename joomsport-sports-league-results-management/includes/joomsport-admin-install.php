    ...
    add_submenu_page( 'joomsport', __('Help', 'joomsport-sports-league-results-management'), __('Help', 'joomsport-sports-league-results-management'),
      'manage_options', 'joomsport_help', array('JoomsportPageHelp', 'action') );
        ...
        if(!current_user_can('manage_options') && (JoomsportSettings::get('moder_create_matches_reg', 0) || JoomsportSettings::get('moder_edit_matches_reg', 0))){
          ...
          $hook = add_menu_page( __( 'Matchday', 'joomsport-sports-league-results-management' ), __( 'Matchdays', 'joomsport-sports-league-results-management' ), 'jsp_matchday_manage', 'joomsport_mday_moder', array('JoomSportModerMday','showMdays'));
          $obj = JoomSportMdayModer_Plugin::get_instance();

          add_action( "load-$hook", function(){ $obj = JoomSportMdayModer_Plugin::get_instance();$obj->screen_option();}  );
        }
