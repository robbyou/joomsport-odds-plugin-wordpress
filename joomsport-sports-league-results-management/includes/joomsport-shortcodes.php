...
class JoomsportShortcodes {
  ...
  public static function init() {
    ...
    add_filter("mce_buttons", array('JoomsportShortcodes',"register_buttons_editor"));
      ...
      /*<!--jsonlyinproPHP-->*/
      add_shortcode( 'jsModerator', array('JoomsportShortcodes','joomsport_moderator') );
      add_shortcode( 'jsLiveMatches', array('JoomsportShortcodes','joomsport_livematches') );
      /*<!--/jsonlyinproPHP-->*/
  }
...
//register buttons with their id.
    ...
    /*<!--jsonlyinproPHP-->*/
    public static function joomsport_moderator($attr){
        ...
        wp_enqueue_script('jsjoomsportmoder',plugin_dir_url( __FILE__ ).'../sportleague/assets/js/joomsport_moderator.js', array('jquery'));
        ...
        wp_enqueue_style('jscssbtstrp',plugin_dir_url( __FILE__ ).'../sportleague/assets/css/btstrp.css');
        wp_enqueue_style('cssjoomsportmoder',plugin_dir_url( __FILE__ ).'../sportleague/assets/css/joomsport_moderator.css');
        ...
        echo '<div id="joomsport-container" class="jsmodtbl_responsive">';
        require JOOMSPORT_PATH_VIEWS . 'widgets' . DIRECTORY_SEPARATOR . 'moderator.php';
        echo '</div>';
        return ob_get_clean();
    }
    /*<!--/jsonlyinproPHP-->*/
    ...
    /*<!--jsonlyinproPHP-->*/
    public static function joomsport_livematches($attr){
        wp_enqueue_style('jscssbtstrp',plugin_dir_url( __FILE__ ).'../sportleague/assets/css/btstrp.css');
        wp_enqueue_style('jscssjoomsport',plugin_dir_url( __FILE__ ).'../sportleague/assets/css/joomsport.css');
        if (is_rtl()) {
            wp_enqueue_style( 'jscssjoomsport-rtl',plugin_dir_url( __FILE__ ).'../sportleague/assets/css/joomsport-rtl.css', array('jscssjoomsport'));
        ...
        wp_enqueue_script( 'mod_js_livematch-js', plugins_url('../assets/js/mod_js_live_matches.js', __FILE__),array('jquery') );
        wp_enqueue_style( 'mod_js_livematch-css', plugins_url('../assets/css/mod_js_live_matches.css', __FILE__) );
        ...
        require_once JOOMSPORT_PATH . DIRECTORY_SEPARATOR. 'includes' . DIRECTORY_SEPARATOR . 'joomsport-live-matches.php';
        $rows = JoomsportLiveMatches::getList();
        echo '<div id="joomsport-container" class="jsmodtbl_responsive">';
        require JOOMSPORT_PATH_VIEWS . 'widgets' . DIRECTORY_SEPARATOR . 'live-matches-header.php';
        echo '</div>';
