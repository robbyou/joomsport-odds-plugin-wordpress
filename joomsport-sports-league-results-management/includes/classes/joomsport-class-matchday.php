...
/*<!--jsonlyinproPHP-->*/
require_once __DIR__.DIRECTORY_SEPARATOR.'matchday_types'.DIRECTORY_SEPARATOR.'joomsport-class-matchday-knockout.php';
/*<!--/jsonlyinproPHP-->*/
class JoomSportClassMatchday{
    ...
    public static function getMdayType($mdID){
        ...
        switch ($metas['matchday_type']){
            case '1':
                /*<!--jsonlyinproPHP-->*/
                $obj = new JoomSportClassMatchdayKnockout($mdID);
                /*<!--/jsonlyinproPHP-->*/
                break;
            default:
